            ...
            {loading ? (
              ...
              <>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div className="absolute right-0 mt-3 w-60 bg-[#0B1120]/98 backdrop-blur-2xl rounded-2xl shadow-2xl shadow-black/50 border border-white/10 py-2 overflow-hidden">
                      <div className="px-4 py-3 bg-gradient-to-r from-[#008080]/10 to-transparent border-b border-white/5">
                      ...
                      <div className="py-1">
                        <Link
                          href="/profile"
                          onClick={closeMenus}
                          className="flex items-center gap-3 px-4 py-2.5 text-white/80 hover:text-[#008080] hover:bg-[#008080]/10 transition-all"
                        >
                        ...
                        <Link
                          href="/events/new"
                          onClick={closeMenus}
                          className="flex items-center gap-3 px-4 py-2.5 text-white/80 hover:text-[#F97316] hover:bg-[#F97316]/10 transition-all"
                        >
